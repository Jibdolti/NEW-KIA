$(document).ready(function () {
    ...
    //     let x = e.clientX
    //     let y = e.clientY
    //     let catName = 'cat-' + catNum++;
    //     let randomNumber = Math.random() * 5
    //     let randomNum = Math.floor(randomNumber);

    //     $('body').append(`<span id="${catName}" class="cat" style="left:${x}px; top:${y}px"></span>`)

    //     if(randomNum == 0){
    //         $('#'+catName).append('<img src="images/1.gif">')
    //     }
    //     if(randomNum == 1){
    //         $('#'+catName).append('<img src="images/2.gif">')
    //     }
    //     if(randomNum == 2){
    //         $('#'+catName).append('<img src="images/3.gif">')
    //     }
    //     if(randomNum == 3){
    //         $('#'+catName).append('<img src="images/4.gif">')
    //     }
    //     if(randomNum == 4){
    //         $('#'+catName).append('<img src="images/5.gif">')
    //     }
    ...
    $('.btn_question').click(function(){
        let checkVal = $('.terms').is(':checked')//:visible //:hidden
        //is() 는 true, false 값을 변환
